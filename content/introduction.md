...
Official model view definitions (MVDs) exist as related specifications. The official MVD policy for IFC 4.4 currently holds 3 levels of implementation for IFC:

- Reference View
- Alignment Based Reference View
- Design Transfer view

These three MVDs can be seen as three levels of implementation for IFC 4.4. They are gradual levels adding more advanced features to the implementations.
{%- if not is_iso %}
